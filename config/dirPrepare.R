# Needs to run once in a file with datasets generated by the elixir pipeline.
# Copy this script in the dir containing the datasets and execute in there
# This will modify all datasets to be compliant with seqcvibe tool

# WARNING: THIS SCRIPT WILL REMOVE FILES, YOU ARE ADVICED TO HAVE A BACK-UP
...
dirSort <- function(dataset) {
  ...
  file.move(files = paste0(dataset,"/multiqc/",paste0(dataset,"_multiqc_report.html")),destinations = dataset)
